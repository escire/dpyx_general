<?php
	define('DEFAULT_TIMEZONE' , 'America/Mexico_City');// set php date functions timezone
	...
	define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['usuario_id'] : null ));
