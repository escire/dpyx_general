	...
	function postresetlink(){
		...
		if(!empty($_POST['email'])){
			...
			if(!empty($user)){
				...
				$db->update( 'usuario', array("password_reset_key"=>$password_reset_key) );
				...
				$this->view->page_error = "La dirección de correo electrónico no está registrada en el sistema";
				$this->view->render('passwordmanager/index.php',null,"info_layout.php");
			}
		}
		else{
