                            ...
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nombre"  value="<?php  echo $data['nombre']; ?>" type="text" placeholder="Nombre"  required="" name="nombre"  class="form-control " />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-telefono"  value="<?php  echo $data['telefono']; ?>" type="text" placeholder="Teléfono"  name="telefono"  class="form-control " />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            ...
                                                            <textarea placeholder="Contacto" id="ctrl-contacto"  rows="" name="contacto" class=" form-control"><?php  echo $data['contacto']; ?></textarea>
