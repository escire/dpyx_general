...
$can_add = PageAccessManager::is_allowed('configuracion/add');
$can_edit = PageAccessManager::is_allowed('configuracion/edit');
$can_view = PageAccessManager::is_allowed('configuracion/view');
$can_delete = PageAccessManager::is_allowed('configuracion/delete');
?>
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <h3 class="record-title">Configuración</h3>
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('configuracion'); ?>">
                                    ...
                                    ?>
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('configuracion') ?>">Buscar</a>
                                    </li>
                                ...
                                <div class="page-records table-responsive">
                                    <table class="table  table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            $rec_id = (!empty($data['configuracion_id']) ? urlencode($data['configuracion_id']) : null);
                                            $counter++;
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['configuracion_id'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    ...
                                                    <td><a href="<?php print_link("configuracion/$data[configuracion_id]") ?>"><?php echo $data['configuracion_id']; ?></a></td>
                                                    
                                                    
                                                    
                                                    
                                                    <td>
                                                        <a <?php if($can_edit){ ?> data-source='<?php echo json_encode_quote(Menu :: $texto_encabezado); ?>' 
                                                            data-value="<?php echo $data['texto_encabezado']; ?>" 
                                                            data-pk="<?php echo $data['configuracion_id'] ?>" 
                                                            data-url="<?php print_link("configuracion/editfield/" . urlencode($data['configuracion_id'])); ?>" 
                                                            data-name="texto_encabezado" 
                                                            data-title=" Nombre" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            ...
                                                            <?php echo $data['texto_encabezado']; ?>  
                                                        </a>
                                                    </td>
