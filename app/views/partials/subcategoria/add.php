            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="subcategoria-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("subcategoria/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
